		...
		<main className="bg-white pb-14 pt-20">
			<div className="mx-auto px-6 max-w-[45rem]">
				...
				<div className="relative flex flex-col items-center">
					...
					<h2 className="text-4xl sm:text-[2.5rem] text-slate-800 font-semibold capitalize mb-2 mt-7 flex items-center">
						{__(`${astra_admin.theme_name} + Spectra = `, "astra")}
						<span className="ml-2">
							{Astra_Admin_Icons['heart-icon']}
						</span>
					</h2>
					...
					<button
						className={`inline-flex items-center px-10 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-astra focus-visible:bg-astra-hover hover:bg-astra-hover hover:text-white focus:text-white active:text-white focus:outline-none`}
